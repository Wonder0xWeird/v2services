...
if (process.env.NODE_ENV === "development") {
	...
	console.log("USING V2SERVICES DEV DATABASE")
} else {
...
if (!MONGODB_URI) {
	throw new Error(
		"Define the MONGODB_URI environment variable"
	)
}
...
if (!MONGODB_DB) {
	throw new Error(
		"Define the MONGODB_DB environment variable"
	)
}
